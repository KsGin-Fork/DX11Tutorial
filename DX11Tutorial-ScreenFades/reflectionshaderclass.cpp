...
bool ReflectionShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	CHAR reflection_vs[] = "./reflection.vs";
	CHAR reflection_ps[] = "./reflection.ps";
	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, reflection_vs, reflection_ps);
	if(!result)
	{
		return false;
	}
...
void ReflectionShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, CHAR* shaderFilename)
{
	char* compileErrors;
