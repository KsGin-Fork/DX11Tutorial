...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	CHAR sphere_txt[] = "./data/sphere.txt";
	CHAR blue_dds[] = "./data/blue.dds";
	// Initialize the model object.
	result = m_Model->Initialize(m_D3D->GetDevice(), sphere_txt, blue_dds);
	if(!result)
	{
	...
	CHAR mouse_dds[] = "./data/mouse.dds";
	// Initialize the bitmap object.
	result = m_Bitmap->Initialize(m_D3D->GetDevice(), screenWidth, screenHeight, mouse_dds , 32, 32);
	if(!result)
	{
