						   ...
						   D3DXMATRIX baseViewMatrix)
{
	...
	CHAR fontdata_txt[] = "./data/fontdata.txt";
	CHAR font_dds[] = "./data/font.dds";
	// Initialize the font object.
	result = m_Font->Initialize(device, fontdata_txt, font_dds);
	if(!result)
	{
	...
	CHAR text[] = "Intersection: No";
	// Now update the sentence vertex buffer with the new string information.
	result = UpdateSentence(m_sentence1, text , 20, 20, 1.0f, 0.0f, 0.0f, deviceContext);
	if(!result)
	{
		return false;
	}
