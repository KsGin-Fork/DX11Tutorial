...
bool ShadowShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, DirectX::XMMATRIX worldMatrix, DirectX::XMMATRIX viewMatrix, 
							   ...
							   ID3D11ShaderResourceView* texture, ID3D11ShaderResourceView* depthMapTexture, DirectX::XMFLOAT3 lightPosition, 
							   DirectX::XMFLOAT4 ambientColor, DirectX::XMFLOAT4 diffuseColor,DirectX::XMMATRIX lightViewMatrix1, DirectX::XMMATRIX lightProjectionMatrix1,
							   ID3D11ShaderResourceView* depthMapTexture1, DirectX::XMFLOAT3 lightPosition1, DirectX::XMFLOAT4 diffuseColor1)
{
	bool result;
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, lightViewMatrix, lightProjectionMatrix, texture, 
								 depthMapTexture, lightPosition, ambientColor, diffuseColor , lightViewMatrix1 , lightProjectionMatrix1 , depthMapTexture1 , lightPosition1 , diffuseColor1);
	if(!result)
	{
		return false;
	}
											...
											ID3D11ShaderResourceView* depthMapTexture1, DirectX::XMFLOAT3 lightPosition1, DirectX::XMFLOAT4 diffuseColor1)
{
	...
	lightViewMatrix1 = DirectX::XMMatrixTranspose(lightViewMatrix1);
	lightProjectionMatrix1 = DirectX::XMMatrixTranspose(lightProjectionMatrix1);
	...
	dataPtr->lightView2 = lightViewMatrix1;
	dataPtr->lightProjection2 = lightProjectionMatrix1;
	...
	deviceContext->PSSetShaderResources(2, 1, &depthMapTexture1);
	...
	dataPtr2->diffuseColor2 = diffuseColor1;
	...
	dataPtr3->lightPosition2 = lightPosition1;
