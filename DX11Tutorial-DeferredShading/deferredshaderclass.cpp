...
bool DeferredShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	CHAR deferred_vs[] = "./deferred.vs";
	CHAR deferred_ps[] = "./deferred.ps";
	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, deferred_vs, deferred_ps);
	if(!result)
	{
		return false;
	}
...
bool DeferredShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, CHAR* vsFilename, CHAR* psFilename)
{
	HRESULT result;
...
void DeferredShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, CHAR* shaderFilename)
{
	char* compileErrors;
