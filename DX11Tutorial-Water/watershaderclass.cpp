...
bool WaterShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	char water_vs[] = "./waterVertexShader.hlsl";
	char water_ps[] = "./waterPixelShader.hlsl";
	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, water_vs, water_ps);
	if(!result)
	{
		return false;
	}
...
void WaterShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, CHAR* shaderFilename)
{
	char* compileErrors;
