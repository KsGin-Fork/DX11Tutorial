...
bool RefractionShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	char refraction_vs[] = "./refractionVertexShader.hlsl";
	char refraction_ps[] = "./refractionPixelShader.hlsl";
	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, refraction_vs, refraction_ps);
	if(!result)
	{
		return false;
	}
...
void RefractionShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, CHAR* shaderFilename)
{
	char* compileErrors;
