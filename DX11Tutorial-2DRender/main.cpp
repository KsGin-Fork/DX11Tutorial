...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, INT nCmdShow) {
	...
	ddEnableStencilopDesc.DepthEnable = true;	//////////////////////////////// 3D中启用深度 //////////////////////////////////////////////////////////////////////
	...
	MatrixXD matrix3d = {
		...
		XMMatrixPerspectiveFovLH(90.0f , static_cast<float>(width) / height , 0.01f , 100.0f)
	};
	...
	dbDesc3D.ByteWidth = sizeof(MatrixXD);
	...
	dsData3D.pSysMem = &matrix2d;
	
	ID3D11Buffer *pMatrixDBuffer2D = nullptr;
	hr = pDevice->CreateBuffer(&dbDesc3D, &dsData3D, &pMatrixDBuffer2D);
	if (FAILED(hr)) {
		MessageBox(nullptr, "ERROR::CreateMatrixBuffer", "ERROR", MB_OK);
		return hr;
	}
