...
inline HRESULT InitScreenVertices(
	const int width , 
	const int height , 
	ID3D11Device *pDevice,
	ID3D11Buffer **pVertexBufferObject,
	...
	vertices[0].pos = XMFLOAT3(- width / 2, -height / 2, 0.0f);
	vertices[0].tex = XMFLOAT2(0.0f, 1.0f);
	vertices[1].pos = XMFLOAT3(- width / 2, height / 2, 0.0f);
	vertices[1].tex = XMFLOAT2(0.0f, 0.0f);
	vertices[2].pos = XMFLOAT3(width / 2, height / 2, 0.0f);
	vertices[2].tex = XMFLOAT2(1.0f, 0.0f);
	vertices[3].pos = XMFLOAT3(width / 2, -height / 2, 0.0f);
